...
% TODO: Introduction
% TODO: Add goal of the architecture and in particual, checking it
...
MINRV8 supports 4 general purpose registers and has two privlege modes, machine- and user-mode.
...
Machine words are generally interpreted as signed-words thus there won't be unsigned counterparts to integer arithemtic or comparison instruction.
...
\begin{table}
    ...
    \begin{tabular}{|l p{10cm}|}
        ...
        SRA $ rd $, $ rs1 $, $ rs2 $ & Set register $ rd $ to the content of register $ rs1 $ shifted right arithemtically (i.e. with sign-extension) by the value in register $ rs2 $ \\
...
The \gls{pmacfg} register defines cachability of the two memory regions.
Each memory region can either be set as uncachable, write-back-cachable, write-through-chachable or write-protected-cachable.
