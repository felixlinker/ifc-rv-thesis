...
For such a region, on a STORE \smvinline{line} will be written with \smvinline{regs[rs1]}, \smvinline{address} with \smvinline{regs[rs2] mod 4} and \smvinline{valid} will become \smvinline{TRUE}.
