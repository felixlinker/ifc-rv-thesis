...
Additionally, roughly 21 bug fix patches\footnote{%
    The number of 21 bug fix patches was measured by counting the amount of patches containing the word \enquote{fix} in its description and being applied to the model file.
