...
\end{lstlisting}
This constraint ensures that the interrupt handling mechanisms are set up correctly and is mandated by the RISC-V specification (cf. section \ref{sec:rv-exn} and figure \ref{fig:interrupt-handling}).
