...
\todo{Replace "requirements" with "objectives"}
...
\begin{description}
    ...
    \item[Machine-generated model] \todo{references to formal models of risc-v} The model of the architecture that was implemented by hand in this thesis could be generated from existing machine-readable architectural specifications.
