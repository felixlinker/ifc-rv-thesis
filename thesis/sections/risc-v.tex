...
For example, \gls{riscv} defines the pseudo-instruction \gls{nop} as \assmblrinline{ADDI x0, x0, 0} the semantics of which is: Add the constant value 0 to x0 and store the result in x0.
