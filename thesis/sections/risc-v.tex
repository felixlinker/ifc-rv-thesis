...
In this section, the architecture to work with will be developed and implemented.
...
To derive a simpler version of the RISC-V architecture, which is called MINRV8, the RISC-V architecture itself will be introduced first in section \ref{sec:risc-v}.
