...
The base integer instruction set provides instructions for addition and subtraction, integer comparisons and the Boolean operators \rv{And}, \rv{Or} and \rv{Xor}.
