...
The following analogy by \citeauthor{Reid17} gives an intuition for this line of research: think of a specification as the law and an implementation as some action that is touched by the law.
